...
func TestServiceFunctionChainCalculation_Execute(t *testing.T) {
	...
	edges := map[int]graph.Edge{
		...
		2:  graph.NewNetworkEdge("2", nodes[1], nodes[3], map[helper.WeightKey]float64{helper.IgpMetricKey: 10, helper.LatencyKey: 2000, helper.JitterKey: 20, helper.PacketLossKey: 2, helper.UtilizedBandwidthKey: 9000, helper.AvailableBandwidthKey: 991000}),  // 1->3  igp metric 10, latency 2ms, jitter 2us, loss 2%, utilization 9Mbit/s, available bandwidth 991Mbit/s
		3:  graph.NewNetworkEdge("3", nodes[1], nodes[4], map[helper.WeightKey]float64{helper.IgpMetricKey: 10, helper.LatencyKey: 1000, helper.JitterKey: 10, helper.PacketLossKey: 1, helper.UtilizedBandwidthKey: 1000, helper.AvailableBandwidthKey: 999000}),  // 1->4  igp metric 10, latency 1ms, jitter 1us, loss 1%, utilization 1Mbit/s, available bandwidth 999Mbit/s
		...
		5:  graph.NewNetworkEdge("5", nodes[3], nodes[5], map[helper.WeightKey]float64{helper.IgpMetricKey: 10, helper.LatencyKey: 3000, helper.JitterKey: 30, helper.PacketLossKey: 3, helper.UtilizedBandwidthKey: 5000, helper.AvailableBandwidthKey: 995000}),  // 3->5  igp metric 10, latency 3ms, jitter 3us, loss 3%, utilization 5Mbit/s, available bandwidth 995Mbit/s
		...
		9:  graph.NewNetworkEdge("9", nodes[6], nodes[8], map[helper.WeightKey]float64{helper.IgpMetricKey: 10, helper.LatencyKey: 1000, helper.JitterKey: 10, helper.PacketLossKey: 1, helper.UtilizedBandwidthKey: 1000, helper.AvailableBandwidthKey: 999000}),  // 6->8  igp metric 10, latency 1ms, jitter 1us, loss 1%, utilization 1Mbit/s, available bandwidth 999Mbit/s
		10: graph.NewNetworkEdge("10", nodes[7], nodes[6], map[helper.WeightKey]float64{helper.IgpMetricKey: 10, helper.LatencyKey: 1000, helper.JitterKey: 10, helper.PacketLossKey: 1, helper.UtilizedBandwidthKey: 2000, helper.AvailableBandwidthKey: 998000}), // 7->6  igp metric 10, latency 1ms, jitter 1us, loss 1%, utilization 2Mbit/s, available bandwidth 998Mbit/s
		11: graph.NewNetworkEdge("11", nodes[7], nodes[8], map[helper.WeightKey]float64{helper.IgpMetricKey: 10, helper.LatencyKey: 5000, helper.JitterKey: 50, helper.PacketLossKey: 5, helper.UtilizedBandwidthKey: 5000, helper.AvailableBandwidthKey: 995000}), // 7->8  igp metric 20, latency 5ms, jitter 5us, loss 5%, utilization 5Mbit/s, available bandwidth 995Mbit/s
	}
